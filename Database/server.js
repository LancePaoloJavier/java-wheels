...
app.use(
  session({
    secret: process.env.SESSION_SECRET || "sakaya-car-rental-secret-key",
    resave: false,
  ...
  try {
    ...
    const sampleCars = [
      ...
      [
        ...
        "Versa",
        "Sedan",
        "/assets/car-options/sedan/nissan-versa.avif",
        "Gasoline",
        "Automatic",
        5,
        45.0,
      ...
      [
        ...
        "Miata",
        "Sedan",
        "/assets/car-options/sedan/mazda-miata.avif",
        "Gasoline",
        "Manual",
        2,
        65.0,
      ...
      [
        ...
        "Mirage",
        "Sedan",
        "/assets/car-options/sedan/mitsubishi-mirage.avif",
        "Gasoline",
        "Automatic",
        5,
        40.0,
      ...
      [
        ...
        "Malibu",
        "Sedan",
        "/assets/car-options/sedan/chevrolet-malibu.avif",
        "Gasoline",
        "Automatic",
        5,
        55.0,
      ...
      [
        ...
        "Niro",
        "SUV",
        "/assets/car-options/suvs/kia-niro.avif",
        "Hybrid",
        "Automatic",
        5,
        70.0,
      ...
      [
        ...
        "Wrangler",
        "SUV",
        "/assets/car-options/suvs/jeep-wrangler.avif",
        "Gasoline",
        "Manual",
        4,
        85.0,
      ...
      [
        ...
        "Kona",
        "SUV",
        "/assets/car-options/suvs/hyundai-kona.avif",
        "Gasoline",
        "Automatic",
        5,
        65.0,
      ...
      [
        ...
        "Transit Wagon",
        "Van",
        "/assets/car-options/vans/ford-transit-wagon.avif",
        "Gasoline",
        "Automatic",
        12,
        95.0,
      ...
      [
        ...
        "Express",
        "Van",
        "/assets/car-options/vans/chevy-express-e35c.avif",
        "Gasoline",
        "Automatic",
        15,
        105.0,
      ...
      [
        ...
        "Express",
        "Van",
        "/assets/car-options/vans/chevrolet-express.avif",
        "Gasoline",
        "Automatic",
        15,
        100.0,
...
app.post("/api/register", async (req, res) => {
  try {
    const { username, email, password, firstName, lastName, contactNumber } =
      req.body;
...
app.get("/api/cars/all", requireAdmin, async (req, res) => {
  try {
    const [cars] = await db.execute(
      "SELECT * FROM cars ORDER BY car_type, name",
    );
    res.json(cars);
  } catch (error) {
...
app.post("/api/cart", requireAuth, async (req, res) => {
  try {
    ...
    await db.execute("INSERT INTO user_carts (user_id, car_id) VALUES (?, ?)", [
      user_id,
      car_id,
    ]);
    ...
    try {
      for (const cart_id of cart_ids) {
        ...
        if (cartItems.length > 0) {
          ...
          // Remove from cart
          await db.execute("DELETE FROM user_carts WHERE cart_id = ?", [
            cart_id,
          ]);
        }
      }
...
app.get("/api/admin/user-activity", requireAdmin, async (req, res) => {
  try {
    ...
    const allActivity = [...cartItems, ...rentals].sort(
